...
public:
	...
	void draw_triangle(float x1, float y1, float x2, float y2, float x3, float y3, SDL_Color color1, SDL_Color color2, SDL_Color color3, int gmode, int isRect = 0, float z1 = 0.0f, float z2 = 0.0f, float z3 = 0.0f);
