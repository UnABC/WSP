...
| random    | i/d   | i/d max                                                                                                                                                | 0からmax-1までの乱数を返す                                               |
...
| dialog    | void  | i/d/s title, i/d/s msg, i/d mode (=0)                                                                                                                  | ダイアログを表示する。                                                   |
...
| texture   | void  | i/d id,i/d mode(=0) i/d x_size(=1.0), i/d y_size(=1.0), i/d angle(=0.0), i/d tex_x(=0.0),i/d tex_y(=0.0),i/d tex_width(=WIDTH),i/d tex_height(=HEIGHT) | 図形を描画するときにテクスチャを適用する。                               |
